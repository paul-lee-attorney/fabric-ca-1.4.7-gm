...
import (
	...
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/attr"
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/attrmgr"
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/caerrors"
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/common"
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/metadata"
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/server/db"
	cadb "github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/server/db"
	cadbfactory "github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/server/db/factory"
	...
	dbutil "github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/server/db/util"
	idemix "github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/server/idemix"
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/server/ldap"
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/server/user"
	cadbuser "github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/server/user"
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/tcert"
...
type CA struct {
	...
	verifyOptions *gmx509.VerifyOptions
...
func (ca *CA) getVerifyOptions() (*gmx509.VerifyOptions, error) {
	...
	var intPool *gmx509.CertPool
	var rootPool *gmx509.CertPool
	...
	for len(chain) > 0 {
		...
		if len(cert.AuthorityKeyId) == 0 || bytes.Equal(cert.AuthorityKeyId, cert.SubjectKeyId) {
			...
			if intPool == nil {
				intPool = gmx509.NewCertPool()
			}
			intPool.AddCert(cert)
		}
	}

	ca.verifyOptions = &gmx509.VerifyOptions{
		Roots:         rootPool,
