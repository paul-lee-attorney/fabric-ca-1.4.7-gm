...
import (
	...
	cax509 "github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/client/credential/x509"
...
func testImpersonation(id *Identity, t *testing.T) {
	...
	fakeCertBytes, err := gmx509.CreateCertificate(rand.Reader, cert, cert, pub, cspSigner)
	if err != nil {
