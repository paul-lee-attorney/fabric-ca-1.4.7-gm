...
import (
	...
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/mocks"
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib/server/certificaterequest"
...
func testInsertCertificate(req *certdb.CertificateRecord, id string, ca *CA) error {
	...
	derBytes, err := gmx509.CreateCertificate(rand.Reader, &template, &template, &priv.PublicKey, priv)
	if err != nil {
