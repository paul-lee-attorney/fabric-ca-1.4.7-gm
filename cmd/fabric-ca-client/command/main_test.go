...
import (
	...
	"github.com/paul-lee-attorney/fabric-ca-1.4.7-gm/lib"
...
`
	...
	cert, perr1 := gmx509.ParseCertificate(block.Bytes)
...
func getSerialAKIByID(id string) (serial, aki string, err error) {
	...
	if err != nil {
		return "", "", fmt.Errorf("Error from gmx509.ParseCertificate: %s", err)
	}
